...
//        frame.pack();
        ...
        table2.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                boolean useDraft = !courseInfoModel.getValueAt(table2.getSelectedRow(), 4).toString().equals("Đã chốt sổ");
                if (useDraft) {
                    makeRightAble();
                } else {
                    makeRightDisable();
    ...
    private class TeacherInfoModel extends AbstractTableModel {
        ...
        String[] columnShowStrings = {"ID", "Tên đăng nhập", "Mật khẩu", "Họ và tên", "Số điện thoại", "Địa chỉ mail"};
    ...
    private class CourseInfoModel extends AbstractTableModel {
        ...
        String[] columnShowStrings = {"ID", "Tên khóa học", "Năm học", "Học kỳ", "Trạng thái bảng điểm"};
